...
const expectedObject = {
  swagger: '2.0',
  info: { title: 'apidoc-swagger', version: '0.3.2', description: 'Convert api doc json to swagger json' },
  paths: {
    '/user/id': {
      get: {
        tags: ['User'],
        ...
        parameters: [{ name: 'id', in: 'path', required: true, type: 'number', description: 'Users unique ID.' }],
        responses: {
          '200': {
  ...
  definitions: {
    GetUser: {
      properties: {
        id: { type: 'number', description: 'Users unique ID.' },
